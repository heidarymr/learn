var timeout,
  ...
  firstTimeLoaded = 0,
  fontSize = 100,
  path = "/apps-data/english-vocabulary-in-use-pre-intermediate-3rd/",
    ...
    $("#section-section").click(function () {
      ($("#answer-popup").remove(),
        ...
        $("#bottom-section")
          .children(".container")
          .html(
            '<div class="app-name">English Vocabulary in Use</div ><div class="app-slogan">Pre-intermediate and Intermediate</div>',
          ),
