var timeout,
  ...
  firstTimeLoaded = 0,
  fontSize = 100,
  path = "/apps-data/4000-essential-english-words-2-2nd-edition/",
    ...
    $("#section-section").click(function () {
      ($("#category-section").find(".container").html(""),
        ...
        $("#bottom-section")
          .children(".container")
          .html(
            '<div class="app-name">4000 Essential English Words 2 (2nd Edition)</div ><div class="app-slogan">Paul Nation</div>',
          ),
