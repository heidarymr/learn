    ...
    $("#section-section").click(function () {
      (0 < $("#idiom-tip-popup").length && $("#idiom-tip-popup").remove(),
        ...
        $("#bottom-section")
          .children(".container")
          .html(
            '<div class="app-name">Most Common Business Idioms in English</div><div class="app-slogan">Hundreds of idiomatic expressions to give you an edge in English!</div>',
          ),
