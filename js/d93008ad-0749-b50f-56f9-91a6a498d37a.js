    ...
    $("#section-section").click(function () {
      ($("#answer-popup").remove(),
        ...
        $("#bottom-section")
          .children(".container")
          .html(
            '<div class="app-name">\u201C4000 Essential English Words 3\u201D</div ><div class="app-slogan">Paul Nation</div>',
          ),
    ...
    if (s != null || null != s) {
      ...
      for (var d = 0; d < s.length; d++) {
        ...
        ((g +=
          ...
          (g += "</div>"),
          (g += "</li>"),
          $("#idioms-block").find(".wordlist").append(g),
          $("#item" + d).attr(
            "source",
