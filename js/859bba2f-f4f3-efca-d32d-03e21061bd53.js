var timeout,
  ...
  firstTimeLoaded = 0,
  fontSize = 100,
  path = "/apps-data/IELTS-Academic-14/",
...
$(function () {
  ...
  if (null == i) {
    ...
    var d = JSON.parse(localStorage.getItem(lfontSetting));
    fontSize = d.fontSize;
  }
  ($.ajax({
    ...
    success: function (e) {
      ...
      for (
        ...
        if (
          (null != c &&
            (!0 == $.parseJSON(c).read ? (a = "play") : (a = "reading")),
          null != d[o].wordlist)
        ) {
          var h = d[o].wordlist.length,
            p = d[o].reading[0].en;
          $("#div-unit")
            .children("ul")
            .append(
    ...
    $("#section-section").click(function () {
      ($("#answer-popup").remove(),
        ...
        $("#bottom-section")
          .children(".container")
          .html(
            '<div class="app-name">IELTS Academic 14</div ><div class="app-slogan">CAMBRIDGE</div>',
          ),
...
function showCategorySection(e, t, i) {
  ...
  var d = JSON.parse(localStorage.getItem(lsetting));
  (null != d && (audioLoop = d.loop),
...
function getSectionItem(e) {
  if (null != sessionStorage[path.split("/")[2] + ":" + e]) {
    ...
    var d = localStorage.getItem(path.split("/")[2] + ":" + e.toLowerCase());
    if (null == d) {
      var r = { read: !1 };
    ...
    if (null != o) {
      ...
      for (var a = 0; a < o.length; a++) {
        ...
        switch (c.toLowerCase()) {
          case "story":
            var y = JSON.parse(localStorage.getItem(lsession)),
              r = {
                title: y.title,
                image: $("#home-section")
                  .children("ul")
            ...
            localStorage.setItem(lsession, JSON.stringify(r));
            var l = "";
            ("" != h && (l += '<div class="wordlist-rotate">' + h + "</div>"),
              (l += '<div class="en-story">' + v + "</div>"),
              (l +=
              ...
              $("#story-block").append(
                '<div class="story-block-cover">' + l + "</div>",
              ),
                        ...
                        ("Sample & Definitions" != $(this).attr("title") &&
                          ...
                          $(this)
                            ...
                            .each(function () {
                              ...
                              d.toLocaleLowerCase() == r.toLocaleLowerCase()
                                ? $("#reading-answer-key table").append(
                                    '<tr style="background:#1EA362; color:white"><td>' +
                                      e +
                                      "</td><td>" +
                          ...
                          $(this)
                            ...
                            .each(function (e) {
                              ...
                              for (
                                ...
                                if ($.trim(r[o]) == d.toLocaleLowerCase()) {
                                  n = !0;
                                  break;
                                }
                              !0 == n && "" != d.toLocaleLowerCase()
                                ? $("#reading-answer-key table").append(
                                    '<tr style="background:#1EA362; color:white"><td>' +
                                      (e + 1) +
                                      "</td><td>" +
      ...
      ($(".audio-script").click(function () {
        let e = $(".audio-script").index(this),
          t = $(".script").eq(e);
        (0 == t.find(".audio-script-icon").length &&
          t.prepend(
            `<p><img class="audio-script-icon" src="icons/audioscript.png"> <b style="color:red">Audioscripts</b></p>`,
          ),
          t.css({ display: "block" }),
          $("html, body").animate(
        ...
        $(".speaker-louder").each(function (e) {
          ($(this).attr("idx", e), (s += $(this).attr("source") + ","));
        }),
        "" != s && (s = s.substring(0, s.length - 1)),
        $("#item0").attr("soundarr", s),
        $("#item0").attr("si", 0));
    }
    if (null != n || null != n) {
      $("#item0")
      ...
      for (var a = 0; a < n.length; a++) {
        var g = n[a].en.substring(0, 1),
          ...
          w = n[a].image,
          m = n[a].sound,
          l = '<li id="voca' + a + '" word="' + h + '">',
          x = JSON.parse(localStorage.getItem(h));
        (null == x
          ? ((l += '<div class="en-word">' + h + "</div>"),
            (l += '<div class="en-desc" style="display:none"></div>'))
          : "" == x.note
            ? ((l +=
                '<div class="en-word">' +
                h +
    ...
    ($(".speaker-louder").click(function () {
      ...
      ((autoPlay = !0),
        ...
        $("#sound").attr("duration", $(this).attr("duration")));
    }),
...
function playSound(t, e) {
  ...
  (e != null &&
    ...
    (elm.ontimeupdate = function () {
      let e = $("#sound").attr("duration").split(","),
        t = elm.currentTime,
        i = t,
        d = !1;
      (e.forEach(function (e) {
        let r = e.split(":");
        if (t > r[0] && t < r[1]) {
          let e = r[1] - parseInt(t);
          ((i = `<div>... ${e} ...</div>`),
            0 == $("#waiting-counter").length &&
              $("body").append(`<div id="waiting-counter"></div>`),
            $("#waiting-counter").html(i),
            (d = !0));
        }
      }),
        !1 == d && $("#waiting-counter").remove());
    })),
    $("#bottom-section").css({ display: "block" }));
  var i = JSON.parse(localStorage.getItem(lsession)),
    d = $("#tbl-last-session" + (parseInt(i.index) + 1)),
    r = d.parent().attr("en");
  (0 < d.length || 0 == d.length
    ? (e == null
        ? $("#bottom-section")
            ...
            .html(
              '<ul id="nav-story"><li source="' +
                e +
                '" style="display:none"><img class="audio-play" status="0" src="icons/play.png" /><span style="margin-left:5px; position:relative; top:-23px"></span></li><li style="display:none">Reading</li><li style="color:yellow; width: 100%">' +
                r +
                "</li></ul>",
            )
        : r == null
          ? $("#bottom-section")
              ...
              .html(
                '<ul id="nav-story"><li source="' +
                  e +
                  '"  style="width:50%"><img class="audio-play" status="0" src="icons/play.png" /><span style="margin-left:5px; position:relative; top:-23px"></span></li><li style="width:50%">Reading</li><li style="color:yellow; display:none"></li></ul>',
              )
          : $("#bottom-section")
              .children(".container")
              .html(
                '<ul id="nav-story"><li source="' +
                  e +
                  '"><img class="audio-play" status="0" src="icons/play.png" /><span style="margin-left:5px; position:relative; top:-23px"></span></li><li>Reading</li><li style="color:yellow">' +
                  r +
                  "</li></ul>",
              ),
      $("#nav-story")
          ...
          switch ($(this).html()) {
            case "Listening":
              ($(window).scrollTop(
                ...
                $("#nav-story").children("li").eq(1).html("Reading"));
              break;
            case "Reading":
              ($(window).scrollTop(
                $(".story-block-cover").eq(1).offset().top - 60,
              ),
                $("#nav-story").children("li").eq(1).html("Writing"));
              break;
            case "Writing":
              ($(window).scrollTop(
                $(".story-block-cover").eq(2).offset().top - 60,
              ),
                $("#nav-story").children("li").eq(1).html("Speaking"));
              break;
            case "Speaking":
              ($(window).scrollTop(
                $(".story-block-cover").eq(3).offset().top - 60,
              ),
                $("#nav-story").children("li").eq(1).html("Listening"));
          }
        }),
      $("#nav-story")
        .children("li")
                ...
                0 < d.length
                  ? !1 == checkUnitOpened(r)
                    ...
                    : ((autoPlay = !1),
                      !0 == showAds() &&
                        JSBridge.LoadStoryAnswerKeyVideoAds(
                          nFullTitle + " loaded. Check it out!",
                        ),
      ...
      "" == $("#nav-story li").eq(0).children("span").html() &&
        ...
        $("#sound").attr(
          "duration",
          $(".speaker-louder").eq(0).attr("duration"),
        )))
    : $("#bottom-section")
        .children(".container")
        .html(
...
function showAds() {
  var e = new Date(),
    ...
    i = { adsCurrentDay: t };
  try {
    var d = localStorage.getItem("adsCurrentDay-" + path.split("/")[2]);
    return null == d
      ? (localStorage.setItem(
...
function showAdsForNextLesson(e, t, i, d) {
  ($(".show-ads-cover").remove(),
    $(document).off("click"),
    0 == $(".show-ads-cover").length &&
      $("body").append(
  ...
  if (null != e && !0 == e.next) {
    ...
    if (t < i.length - 1) {
      ...
      ($("#item" + currentReadingIndex).attr("source", r),
        $("#item" + currentReadingIndex).attr("si", d),
        $("html, body").animate(
          { scrollTop: $(".speaker-louder").eq(d).offset().top - 100 },
          600,
          function () {
            (playSound(currentReadingIndex, r),
              $("#nav-story li")
                .eq(0)
                .children("span")
                .html($(".speaker-louder").eq(d).attr("title")),
              $("#sound").attr(
                "duration",
                $(".speaker-louder").eq(d).attr("duration"),
              ));
          },
        ));
    }
...
function homeScroll() {
  ($(window).scroll(function () {
    var e = parseInt($("#home-section").height()),
      ...
      i = $(window).height(),
      d = parseInt($(this).scrollTop());
    $("#home-section").attr("home") == null &&
      $("#home-section").attr("top", d);
    var r = 0,
      n = 0,
      o = 0,
      s = 0;
    (0 < $(".story-block-cover").length &&
      ((r = $(".story-block-cover").eq(0).position().top),
      (n = $(".story-block-cover").eq(1).position().top),
      (o = $(".story-block-cover").eq(2).position().top),
      (s = $(".story-block-cover").eq(3).position().top)),
      d >= r - parseInt($(window).height()) + 150 &&
        $("#bottom-section")
          .find("#nav-story")
          .children("li")
          .eq(1)
          .html("Reading"),
      d >= n - parseInt($(window).height()) + 150 &&
        $("#bottom-section")
          .find("#nav-story")
          .children("li")
          .eq(1)
          .html("Writing"),
      d >= o - parseInt($(window).height()) + 150 &&
        $("#bottom-section")
          .find("#nav-story")
          .children("li")
          .eq(1)
          .html("Speaking"),
      d >= s - parseInt($(window).height()) + 150 &&
        $("#bottom-section")
          .find("#nav-story")
          .children("li")
          .eq(1)
    ...
    null == answerTimerInterval &&
      (answerTimerInterval = setInterval(function () {
        var e = $("#answer-popup div").eq(1).html().split(":"),
          ...
          i = parseInt(e[0]);
        59 < t && (++i, (t = 0));
        var d = $("#answer-popup div").eq(0).html().split("/"),
          r = $("#answer-popup div").eq(2).html().split("/"),
          n = parseInt(d[0]) + parseInt(r[0]);
        ((59 < i || n >= parseInt(d[1])) &&
          (clearInterval(answerTimerInterval),
          0 < parseInt(r[0]) &&
            ($(".exercise-section-red-answer-key").css({
...
function wordnote(e) {
  ...
  if (null == i) {
    var r = {};
    ((r.note = ""), (d = ""), localStorage.setItem(t, JSON.stringify(r)));
  } else null != i.note && (d = i.note);
  var n = e.attr("windex");
  (e
    .parent()
    .parent()
