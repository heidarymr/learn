var timeout,
  ...
  firstTimeLoaded = 0,
  fontSize = 100,
  path = "/apps-data/basic-tactics-for-listening-3rd/",
    ...
    $("#section-section").click(function () {
      ($("#answer-popup").remove(),
        ...
        $("#bottom-section")
          .children(".container")
          .html(
            '<div class="app-name">Basic Tactics for Listening</div ><div class="app-slogan">3rd Edition</div>',
          ),
    ...
    success: function (e) {
      ...
      for (
        ...
        var o = t[r].en,
          s = t[r].desc;
        null == s && (s = "Unit");
        var d = urlFriendlyFull(s.toLowerCase());
        0 == $("#div-" + d).length &&
          ($("#home-section").append(
            '<div id="div-' +
              d +
          ...
          (n += 1));
        var a = "waiting",
          l = localStorage.getItem(path.split("/")[2] + ":" + o.toLowerCase());
        if (
          (null != l && (a = 1 == $.parseJSON(l).read ? "play" : "reading"),
          null != t[r].wordlist)
        ) {
          var c = t[r].wordlist.length,
            h = t[r].reading[0].en;
          $("#div-" + d)
            .children("ul")
            .append(
