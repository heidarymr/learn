var timeout,
  ...
  firstTimeLoaded = 0,
  fontSize = 100,
  path = "/apps-data/illustrated-everyday-expressions-with-stories-1/",
    ...
    $("#section-section").click(function () {
      ($("#answer-popup").remove(),
        ...
        $("#bottom-section")
          .children(".container")
          .html(
            '<div class="app-name">illustrated Everyday Expressions</div><div class="app-slogan">with Stories 1</div>',
          ),
